...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Validation1')
...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('Validation2')
